...
public class CollezioneController {
	...
	public String newCollezione(@ModelAttribute("collezione") Collezione collezione,/*@RequestParam("curator")String curatore*/ Model model, BindingResult bindingResult) {
		
		this.collezioneValidator.validate(collezione, bindingResult);
//		curatore.trim();
//		String[] c = curatore.split("\\s+");
		if(!bindingResult.hasErrors()){
//			collezione.setCuratore(this.curatoreService.curatorePerNomeAndCognome(c[0],c[1]).get(0));
