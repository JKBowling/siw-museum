...
public class Curatore {
	...
	public Curatore(String nome, String cognome, LocalDate dateofBirth, String luogoNascita, String email,
	...
	public String toString() {
		return "Curatore [id=" + id + ", nome=" + nome + ", cognome=" + cognome + ", dateofBirth=" + dateofBirth
